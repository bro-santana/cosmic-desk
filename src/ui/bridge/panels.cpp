...
constexpr float kToggleW = 40.0f;      // autostart toggle
...
void draw_settings_panel(const BridgeInput& in, BridgeState* state, BridgeAction* out_action) {
    ...
    // Autostart row height: the toggle (20 px) is taller than the copy (12.5 px).
    ...
    const float h =
        ...
        toggle_row_h + kSectionGap * scale + footnote_h + pad_y;
